...
figure('DefaultAxesFontSize',axis_sz)
plot(t,x(:,7),'Color',[0.9290, 0.6940, 0.1250],'LineWidth',line_wdth)
legend('$I_{wf}$')
set(legend,'FontSize',legend_sz,'interpreter','latex')
ax = gca;
ax.YAxis.Exponent = 0;
title('Inf. \emph{Wolb}-free','interpreter', 'latex','FontSize', title_sz)
xlim([0 1095])
ylim([0 1.75*10^8])
set(gcf,'color','w');
export_fig(strcat(save_folder,'\',this_file, '_iwf.png'), '-m0.83')
cleanfigure()
