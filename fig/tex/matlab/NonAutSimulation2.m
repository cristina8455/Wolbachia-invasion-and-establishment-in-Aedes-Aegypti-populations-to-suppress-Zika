% Non Autonoums model
% initial values 
% From Simulation 1 to 2 we changed Swi from 250,000 to 850,000
x0 = [10000000,... % Sh[0]
        3000000,... % Eh[0]
        2500000,... % Ih[0]
        10000,... % Rh[0]
        ...
        250000,... % Mwf[0]
        500000,... % Awi[0]
        1850000,... % Swi[0] % had to change it to that instead of 850000
        50000,... % Iwi[0]
        250000]; % Mwi[0]
...
set(gcf,'color','w');
export_fig(strcat(save_folder,'\',this_file, '.png'), '-m0.83')
...
cleanfigure()
matlab2tikz(strcat(save_folder,'\',this_file, '.tex'));
